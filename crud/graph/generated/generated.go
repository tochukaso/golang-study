...
type ComplexityRoot struct {
	...
	Product struct {
		...
		ProductDetail func(childComplexity int) int
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Product.janCode":
		if e.complexity.Product.JanCode == nil {
			break
		}

		return e.complexity.Product.JanCode(childComplexity), true

	case "Product.orgCode":
		if e.complexity.Product.OrgCode == nil {
			break
		}

		return e.complexity.Product.OrgCode(childComplexity), true

	case "Product.productDetail":
		if e.complexity.Product.ProductDetail == nil {
			break
		}

		return e.complexity.Product.ProductDetail(childComplexity), true
...
var sources = []*ast.Source{
	{Name: "graph/schema.graphqls", Input: `# Date型は標準のScalarには未登録
...
func (ec *executionContext) _Product_deletedAt(ctx context.Context, field graphql.CollectedField, obj *model.Product) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Product().DeletedAt(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Product_orgCode(ctx context.Context, field graphql.CollectedField, obj *model.Product) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Product_janCode(ctx context.Context, field graphql.CollectedField, obj *model.Product) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Product_productDetail(ctx context.Context, field graphql.CollectedField, obj *model.Product) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Query_getProduct(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetProduct(rctx, args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputNewProduct(ctx context.Context, obj interface{}) (model.NewProduct, error) {
	...
	for k, v := range asMap {
		...
		case "orgCode":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("orgCode"))
			it.OrgCode, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		case "janCode":
			...
			it.JanCode, err = ec.unmarshalOString2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		case "productDetail":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("productDetail"))
			it.ProductDetail, err = ec.unmarshalOString2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		case "productPrice":
		...
		case "Review":
			...
			it.Review, err = ec.unmarshalOInt2ᚖint(ctx, v)
			if err != nil {
				return it, err
			}
		case "productImage":
			...
			it.ProductImage, err = ec.unmarshalOString2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		}
	...
	for i, field := range fields {
		...
		case "deletedAt":
			...
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Product_deletedAt(ctx, field, obj)
				return res
			})
		case "productName":
		...
		case "orgCode":
			out.Values[i] = ec._Product_orgCode(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&invalids, 1)
			}
		case "janCode":
			out.Values[i] = ec._Product_janCode(ctx, field, obj)
		case "productDetail":
			out.Values[i] = ec._Product_productDetail(ctx, field, obj)
		case "productPrice":
